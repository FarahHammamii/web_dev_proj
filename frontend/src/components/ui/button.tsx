  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        gradient: "bg-gradient-primary text-primary-foreground shadow-md hover:shadow-lg hover:shadow-primary/25 active:scale-[0.98] btn-shine",
        hero: "bg-gradient-hero text-primary-foreground shadow-lg hover:shadow-xl hover:shadow-primary/30 active:scale-[0.98] btn-shine font-semibold",
        ...
        glass: "bg-card/50 backdrop-blur-md border border-border/50 hover:bg-card/80 text-foreground shadow-sm",
        ai: "bg-gradient-accent text-accent-foreground shadow-md hover:shadow-lg active:scale-[0.98] btn-shine relative overflow-hidden",
      },
      size: {
